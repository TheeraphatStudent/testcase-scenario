...
import { calculateTestStats } from '../data/mockData';
...
import { createDocument, getCollection } from '../utils/hooks/useFirebaseDB';
...
function App() {
  ...
  const handleCreateTestCase = async (newTestCase: TestCase) => {
    try {
